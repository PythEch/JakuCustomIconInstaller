namespace MobileDevice
{
    ...
    {
        private static DirectoryInfo ApplicationSupportDirectory;
        private static FileInfo iTunesMobileDeviceFile;
        ...
        static MobileDevice()
        {
            ...
            {
                throw new Exception("iTunes is not installed or damaged!");
            }
            string directoryName = iTunesMobileDeviceFile.DirectoryName;
            if (!iTunesMobileDeviceFile.Exists)
            {
                directoryName = Environment.GetFolderPath(Environment.SpecialFolder.CommonProgramFilesX86) + @"\Apple\Mobile Device Support";
            }
